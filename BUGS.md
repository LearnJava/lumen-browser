...
BUG-046 | OPEN  | layout          | 3 пред-существующих падения lumen-layout --lib: collect_picture_{supported,unsupported}_type (picture выбирает hero.webp вместо hero.jpg — webp считается поддерживаемым?), non_cell_col_row_span_defaults_to_one (panic "expected at least one element child" после full HTML5 tree builder) | layout/src/lib.rs:12253,12269,979
```
