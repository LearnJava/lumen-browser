...
**Что видно на скринах (2026-05-15):**  
Chrome (Claude desktop preview): все секции цветных плашек отображаются корректно — именованные цвета (red/green/blue/...), hex (#e53e3e, #38a169, ...), rgb/rgba, серая шкала, сочетания фон+текст — все с правильными фонами.  
Lumen: те же плашки — чистый текст без фона. Единственный рабочий фон — шапка `.hdr` (задана через CSS-класс).
