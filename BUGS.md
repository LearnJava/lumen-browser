...
BUG-156 | OPEN | paint/layout | TEST-27 регрессия: direction:rtl 0.38%→0.52% (+0.14%) после мержей PH3-4/PH3-5 (2026-06-15). Тест проверяет LTR/RTL выравнивание через цветные полосы. Порог 0.5% пересечён; изменение минимальное, возможно шум gdigrab, но требует диагностики | graphic_tests/27-direction-rtl.html
BUG-157 | OPEN | paint | TEST-40 регрессия: conic-gradient/repeating-conic-gradient 0.48%→0.61% (+0.13%) после мержей PH3-4/PH3-5 (2026-06-15). CSS Images L4 §3.7. Порог 0.5% пересечён; изменение минимальное — возможна связь с измением рендер-пайплайна в OffscreenCanvas | graphic_tests/40-conic-gradients.html
```
