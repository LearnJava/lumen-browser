...
BUG-007 | FIXED       | layout          | <sub>/<sup>/<small> missing UA styles
BUG-008 | FIXED       | layout          | <del>/<ins>/<u>/<s> text-decoration missing UA styles
BUG-009 | FIXED       | layout          | <a> missing UA styles (no blue color, no underline)
BUG-010 | OPEN        | layout/paint    | <hr> renders nothing
BUG-011 | OPEN        | layout/paint    | list markers (bullet, numbers) not rendered
BUG-012 | FIXED       | layout          | <del>/<ins> break inline flow (each on new line)
...
**Статус:** FIXED 2026-05-20 (ветка `ua-stylesheet-phase1`)  
