...
| [BUG-226](bugs/BUG-226-OPEN.md) | OPEN | paint | SVG stroke не центрирован на кромке — рисуется целиком ВНУТРИ бокса (border-box-модель), Edge центрирует (½ наружу + ½ внутрь, SVG 2 §13.7). Затрагивает rect/circle/ellipse во всех SVG-тестах. TEST-47: ±5px на orange-core (79×59 vs Edge 89×69 при stroke-width 10) |
