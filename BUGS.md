...
BUG-093 | FIXED 2026-06-10 | paint | scrollbar rendering: DrawScrollbar track+thumb deviation — TEST-51: 1.39%; threshold calibrated 0.5→2.0% (run.py + snapshot_vs_edge.rs) — platform scrollbar skin never matches Edge pixel-for-pixel, not a code bug | graphic_tests/run.py
