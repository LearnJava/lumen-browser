...
BUG-145 | OPEN  | paint | РЕГРЕССИЯ после мержей P2 2026-06-12 (BUG-084 border-radius AA / BUG-088 / 94628e6d PushFilter bounds): TEST-30 18.81%→30.68%, TEST-103 (filter×transform) 7.33%→49.59% — гигантский серый ромб на полстраницы, контент фильтр-ячеек пропал; оба теста с PushFilter, кандидат — PushFilter bounds fix | crates/engine/paint/src/backends/femtovg_backend.rs
```
