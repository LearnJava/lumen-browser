...
BUG-132 | OPEN  | paint | INTERACTION TEST-101 (border-radius×overflow) 4.04%: overflow:hidden у скруглённого бокса не режет детей по скруглённому контуру (углы бара, круг из квадрата, pill, вложенные радиусы); --bisect 101 | crates/engine/paint/src/display_list.rs
BUG-133 | OPEN  | paint | INTERACTION TEST-102 (opacity×z-index) 17.04%: контрольные ячейки c2/c5 проходят, падают group-opacity сценарии — двойное затемнение перекрытия внутри opacity-группы, z-index не заперт в opacity stacking context, вложенная opacity 0.6×0.5 ≠ 0.3; --bisect 102 | crates/engine/paint/src/compositor.rs
...
BUG-137 | OPEN  | paint | INTERACTION TEST-106 (transform×z-index) 4.02%: transformed-элемент как stacking context — negative z внутри, порядок z-детей в rotate/scale-родителе; контроль c5 без transform тоже в diff-области (см. BUG-139 как вероятную общую причину); --bisect 106 | crates/engine/paint/src/display_list.rs
