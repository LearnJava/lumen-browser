...
BUG-148 | OPEN  | shell | test panels::print_panel::tests::hit_page_range_field fails on main (с W-2b 61375f84): hit-test возвращает ScaleDecrease вместо PageRangeField — кнопки масштаба перекрывают rect поля page-range | crates/shell/src/panels/print_panel.rs:924
```
