...
# втягивает его тесты. Потолок «64 отдельных тест-бинаря» снят задачей BT-1
# (2026-06-21): driver-тесты консолидированы в один бинарь tests/all.rs
# (линковка 1м50с → 7.6с). Этот скрипт по-прежнему полезен, чтобы не тянуть
# несвязанные крейты.
