...
- **`new CSSStyleSheet()`/`.replaceSync()`/`.replace()`/`document.adoptedStyleSheets`/`shadowRoot.adoptedStyleSheets`/`.insertRule()`/`.deleteRule()`** (CSSOM-5, done 2026-09-06, [BUG-897](../bugs/BUG-897-OPEN.md)) — the write half of CSSOM-1 above.
