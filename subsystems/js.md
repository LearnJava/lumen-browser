...
- **`document.styleSheets`/`<style>`/`<link>.sheet`/`CSSStyleSheet`/`CSSRule`-иерархия, только чтение** (CSSOM-1, `docs/tasks/p1-cssom-1-stylesheets.md`, 3 среза, 2026-09-03; closes the read half of [BUG-471](../bugs/BUG-471-OPEN.md)/[BUG-746](../bugs/BUG-746-OPEN.md)).
