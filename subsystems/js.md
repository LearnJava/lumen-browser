...
- **Frame bridge: `<iframe>` browsing context from JS** (`crates/js/src/frame_bridge.rs`, BUG-480 slices 2–5, P3 2026-08-23…25).
  ...
  - Not wired yet: events across isolates, script execution/resource fetch for inserted nodes, frame layout/paint/rAF, frame navigation/replacement/removal, sibling postMessage edges, bfcache of frames. Dynamic (script-inserted) iframes never load — BUG-885.
