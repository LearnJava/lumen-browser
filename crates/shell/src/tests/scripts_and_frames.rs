...
/// ребёнка (`canvas_background_color` читает его read-only с `<body>`, когда
/// у `<html>` своего фона нет — BUG-1103), а не фон СТРАНИЦЫ, который иначе
/// просвечивал бы сквозь остаток фрейма
