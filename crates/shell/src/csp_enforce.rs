...
//! выше), честная независимая
//! проверка заголовка и `<meta>` вместо их слияния, `ServiceWorker`
//! конструирование и его `importScripts()` (`sw_worker.rs` — не гейтится
//! вовсе, шире объёма среза 13/28). См. `bugs/BUG-811-OPEN.md`.
