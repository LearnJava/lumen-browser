...
use super::*;
// P1/SPLIT-DL2: build/build_ordered/fills/texts остаются в `mod tests` в
// display_list.rs — общие хелперы всей группы DL, ещё не вынесенные оттуда.
use super::tests::{build, build_ordered, fills, texts};
