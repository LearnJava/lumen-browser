...
// из этого файла батчами SPLIT-ST3/ST4/ST5/ST6/ST7 (docs/tasks/p1-monolith-split-queue.md §4).
mod apply;
mod logical;
mod parse;
mod shorthand;
...
use apply::css_wide::apply_css_wide_keyword;
...
use shorthand::{
    apply_flex_flow_shorthand, apply_flex_shorthand, apply_grid_area_shorthand,
    apply_grid_line_shorthand, apply_text_emphasis_shorthand, apply_text_wrap_shorthand, find_slash,
    parse_contain_intrinsic_one, parse_contain_intrinsic_size, parse_text_decoration_shorthand_q,
    parse_text_decoration_thickness, parse_text_emphasis_position, parse_text_emphasis_style,
};
...
use parse::box_sides::{
    apply_border_shorthand, apply_border_side_shorthand, expand_4_sides, expand_border_4,
    parse_anchor_size_func, parse_border_style_kw, parse_border_style_opt, parse_break_value,
    parse_inset_area_keyword, parse_line_width, parse_margin_shorthand, parse_outline_color_opt,
    parse_outline_style_opt, parse_overscroll_behavior, parse_padding_shorthand,
    parse_radius_length, parse_scroll_snap_align, parse_scroll_snap_type, resolve_box_length,
    resolve_svg_length, set_inset_side, set_margin_side, set_padding_side,
    split_border_radius_slash, split_box_tokens, split_radius_pair,
};
use parse::color::{encode_srgb, named_color, parse_color_legacy, parse_css_color_legacy};
use parse::content::parse_content_items;
use parse::counters::{is_css_ident, parse_counter_list, parse_quotes};
use parse::font_size::{FontSizeBasis, apply_font_size, apply_line_height_value, parse_font_shorthand};
use parse::image::{
    apply_mask_longhand, is_gradient_function, is_image_set_value, parse_background_size_value,
    parse_cross_fade, parse_paint_function, parse_single_bg_layer, parse_single_mask_layer,
    parse_url_value,
};
use parse::shape::parse_clip_path;
use parse::timeline::{
    apply_animation_shorthand, apply_scroll_timeline_shorthand, apply_transition_shorthand,
    apply_view_timeline_shorthand, parse_animation_timeline_list, parse_scroll_axis,
    parse_time_list,
};
use parse::transform::{parse_angle_to_radians, parse_filter_list, parse_length_px};
