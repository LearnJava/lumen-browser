...
// BUG-531: `CSS.registerProperty()` (`crates/js/src/css_properties_values_api.rs`)
...
pub use parse::color::{canonical_specified_color, parse_color, parse_color_function, system_color};
...
// CSSOM-2 срез 16: internal-only serializer, not crate-public API like the
...
pub(in crate::style) use substitute::{
    expand_attr_val, expand_custom_functions_scoped, expand_mixin_apply, expand_vars,
};
