...
pub use parser::{
    ...
    ComplexSelector, Declaration, ImportRule, MediaCondition, MediaContext, MediaFeature,
    MediaOrientation, MediaQuery, MediaRule, NthSpec, PropertyRule, PseudoClass, RelativeSelector,
    Rule, SimpleSelector, Specificity, Stylesheet,
};
