...
| 7B.5 | ⬜ **`[P3+P1]` Find-in-page с regex** | `shell` + visible-text итератор | требует P1: visible text iteration в layout |
...
- **14.5** `[P3+P1]` Find-in-page с regex. **P3** — UI поисковой строки и highlight через display list overlay; **P1** — обход visible text в layout-дереве с координатами для подсветки
