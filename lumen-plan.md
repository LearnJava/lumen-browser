...
- 🔄 object-fit / object-position для `<img>` [P2] — image-object-fit — 2026-05-14
...
- **`[P3]` HTTP auth (Basic / Digest / Negotiate) + client certificates.** Popup для credentials, NTLM/Negotiate для корп. AD, mTLS для банков / госуслуг. Без этого corporate web недоступен.
