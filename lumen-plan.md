...
- 🔄 VVAR parser (Vertical Metrics Variations) [P2] — vvar-parser — 2026-05-18
...
- **`[P2]`** Variable fonts (fvar/gvar/avar/HVAR/VVAR) в `lumen-font`.
