...
| `NetworkTransport` | HTTP-стек | hyper, cronet-like, тестовый mock |
| `RenderBackend` | растеризация | tiny-skia (CPU), wgpu (GPU), headless |
| `EncodingDetector` | определение кодировки HTML | encoding_rs, кастомный для legacy |
