...
KNOWN_DEBTORS: dict[str, tuple[str, float]] = {
    ...
    '62': ('BUG-642', 0.75),    # Перецелён из BUG-277 (BUG-277 срез 18, 2026-08-05): ратчет 8.01→0.75 —
    ...
    #   высоты и остаётся у верхнего края растянутой ячейки. Заведён [BUG-642](bugs/BUG-642-OPEN.md) —
