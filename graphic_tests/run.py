...
TESTS: list[tuple[str, str, float, str]] = [
    ...
    ('02', '02-color-named.html', 5.0,  'color-named'),
    ('03', '03-color-formats.html', 5.0, 'color-formats'),
    ('04', '04-color-alpha.html', 5.0,  'color-alpha'),
    ('05', '05-border-width.html', 5.0, 'border-width'),
    ('06', '06-border-sides.html', 5.0, 'border-sides'),
    ('07', '07-box-sizing.html',  5.0,  'box-sizing'),
    ('08', '08-padding.html',     5.0,  'padding'),
    ('09', '09-margin.html',      5.0,  'margin'),
    ('10', '10-min-max-width.html', 5.0, 'min-max-width'),
    ('11', '11-min-max-height.html', 5.0, 'min-max-height'),
    ('12', '12-display.html',     5.0,  'display'),
    ('13', '13-visibility-opacity.html', 5.0, 'visibility-opacity'),
    ('14', '14-overflow.html',    5.0,  'overflow'),
    ('15', '15-box-shadow.html',  5.0,  'box-shadow'),
    ('16', '16-outline.html',     5.0,  'outline'),
    ('17', '17-calc.html',        5.0,  'calc'),
