...
KNOWN_DEBTORS: dict[str, tuple[str, float]] = {
    ...
    '54': ('BUG-173', 1.14),    # 2.30→1.14 (2026-06-30): nonzero <path> fill теперь нативный (DrawSvgFill), triangle-soup AA-швы заливки убраны. Остаток = stroke/dash AA (BUG-247-класс), BUG-173 OPEN
