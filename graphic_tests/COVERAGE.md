...
| 47-svg-basic.html | SVG basic shapes in document flow | 14 | rect · rect rx/ry · circle · ellipse · line · group `<g>` · viewBox scale 2× · viewBox with min_x/min_y offset · multiple shapes no viewBox |
