...
| P3-h3 | P3 | | active | | | В работе (P1, ветка p1-h3): срез 1 — QUIC varint (RFC 9000 §16) + HTTP/3 frame codec (RFC 9114 §7.2), pure parse/serialize без IO. Остаётся: QPACK, QUIC transport (UDP+TLS 1.3+loss recovery), streams, h3_do_request | HTTP/3 |
