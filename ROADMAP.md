...
| P3-spell | P3 | | active | | | PARTIAL 2026-07-02 (смешанное программирование, nemotron-3-ultra, срез 1): lumen_core::spell — pure-Rust движок Hunspell-формата (.aff/.dic: TRY/SFX/PFX/cross-product, condition-классы, check case-insensitive, suggest edit-distance-1, 12 тестов, без новых зависимостей); дошить — реальные ru/en словари в data/, подключение SpellChecker в шелле (contenteditable/forms), squiggly + suggestions в UI | Spell check (Hunspell, русский словарь) |
