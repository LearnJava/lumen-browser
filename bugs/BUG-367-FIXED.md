...
**Статус:** FIXED 2026-08-10 (пункты 1, 2, 3, 5; пункт 4 выделен в [BUG-747](BUG-747-FIXED.md))
...
выделен в отдельную заявку [BUG-747](BUG-747-FIXED.md) — это переработка фабрики
