...
[BUG-444](BUG-444-OPEN.md) — у checkedness хранилища всё ещё нет, `checked`
по-прежнему едет на content-атрибуте. Механизм для починки теперь есть: такое
же хранилище в `Document` рядом с `dirty_values`.
