...
**Побочная находка.** Проба вскрыла [BUG-442](BUG-442-FIXED.md): на V8
...
* [BUG-378](BUG-378-FIXED.md) — почему `_lumen_request_focus` вообще виден
  странице.
* [BUG-360](BUG-360-FIXED.md) — `onfocus="…"` не работал бы и после починки
