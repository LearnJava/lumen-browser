# BUG-820 — `<video>` — заглушка тоньше `<audio>`: нет `volumechange`, `networkState`/`currentSrc` не существуют, алгоритм выбора ресурса не запускается, а `loadedmetadata` приходит до всякого `src`
