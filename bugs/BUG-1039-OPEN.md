...
Прямым сравнением `20260908-122932.json` (мой прогон, LAYOUT-2 срез 10, некоммичен) против
...
построчная проверка в этой сессии это подтвердила для среза 10), но сам механизм не является
