...
**Статус:** OPEN — пять движковых дефектов на пути исправлены
(`document.head`, `element.dataset`, [BUG-571](BUG-571-FIXED.md),
[BUG-721](BUG-721-FIXED.md), [BUG-722](BUG-722-FIXED.md), см. «Что уже
исправлено»); после BUG-722 клиентский рендер **начался** (React-узлов
10 → 105 из эталонных 2380), остаток описан ниже
...
## Что известно об остатке (после BUG-722) — актуальное
