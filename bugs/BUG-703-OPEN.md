...
**Статус:** OPEN — заблокирован [BUG-571](BUG-571-OPEN.md); два движковых
дефекта на пути исправлены (см. «Что уже исправлено»)
...
[BUG-571](BUG-571-OPEN.md) — динамически вставленный `<script>` не
