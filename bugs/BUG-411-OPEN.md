...
Это регрессия катовера на V8 (ADR-018, 2026-07-14): на `--features quickjs` сторож
корректен, на дефолтной сборке — мёртвый код. Тот же класс, что [BUG-348](BUG-348-OPEN.md)
(рабочий на QuickJS путь молча ломается на V8-дефолте).
