...
**Статус:** FIXED 2026-07-20 (пункты 1–2; пункт 3 остаётся за [BUG-322](BUG-322-FIXED.md))
**Дата:** 2026-07-20
...
3. **`instanceof HTML*Element` для нативных элемент-обёрток** — обёртки
   ...
   Общий долг, трекается как [BUG-322](BUG-322-FIXED.md): чтобы `instanceof` заработал, надо
...
plain-объектами), трекается как [BUG-322](BUG-322-FIXED.md). WPT
