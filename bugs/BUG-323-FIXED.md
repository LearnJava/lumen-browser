...
элементов в HTML namespace — см. также [BUG-322](BUG-322-OPEN.md), не путать: namespace-сворачивание
...
`list[exposedName] instanceof Element` (строка 47) — эта часть зависит от [BUG-322](BUG-322-OPEN.md)
...
случае из-за [BUG-322](BUG-322-OPEN.md) (строка 47, `instanceof`).
