...
**Статус:** DUPLICATE → [BUG-478](BUG-478-FIXED.md)
**Тип:** дубликат [BUG-478](BUG-478-FIXED.md) — тот же отсутствующий `Element.prototype.getClientRects()`, заведённый другим срезом. Выживает первый по дате (BUG-478, 2026-08-02); уникальные замеры этой записи перенесены туда. Слит 2026-09-02 ре-триажем пула WPT-RUN-5/6.
