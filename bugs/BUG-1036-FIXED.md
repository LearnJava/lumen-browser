...
**Заведён:** 2026-09-08 (P3), при разборе верхнего указателя `STATUS-P3.md` → [BUG-1031](BUG-1031-FIXED.md)
...
[BUG-1011](BUG-1011-OPEN.md)/[BUG-1022](BUG-1022-FIXED.md)/[BUG-1031](BUG-1031-FIXED.md)) —
...
**Проверено и отклонено как причина [BUG-1031](BUG-1031-FIXED.md):** живой прогон
...
не найденный механизм, не эта конкретная дыра. Настоящая причина найдена и починена отдельно —
см. [BUG-1031-FIXED.md](BUG-1031-FIXED.md) (не отравленный `Mutex`, а навсегда зависающая после
интерцепта навигация).
