...
**Чего фикс не трогает.** `scrollend` тогда не диспатчился ниоткуда — фикс
оставил для него готовую точку постановки (кадровый шаг), но ни функции, ни
правила «скролл завершился» не завёл; и то и другое добавлено в
[BUG-822](BUG-822-FIXED.md) (2026-08-24).
