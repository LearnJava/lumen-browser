# BUG-832 — клик по `<a href="#x">` перезагружает документ вместо фрагментной навигации: `hashchange` не приходит, страница стартует заново (на автокликающей странице — бесконечный цикл)
...
и у него ожидание всё равно упирается в обход истории (BUG-834), так что
