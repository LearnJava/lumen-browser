...
`crates/engine/paint/src/display_list.rs:12459` **fn** `emit_text_with_highlights` — CSS Custom Highlight API L1 — helper to emit DrawText with highlight name
...
---
*Total: 3718 symbols in 20 crates*
