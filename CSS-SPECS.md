...
| Media Queries L4/L5 | [mediaqueries-4](https://www.w3.org/TR/mediaqueries-4/) | 🟡 | prefers-reduced-motion ✅; hover/any-hover/pointer/any-pointer ✅ 2026-06-14 (p4-media-hover-pointer: desktop defaults hover/fine); prefers-contrast/prefers-reduced-data ✅ 2026-06-16 (p4-media-contrast-data); prefers-reduced-transparency ✅ 2026-06-19 (p4-prefers-reduced-transparency); scripting ✅ 2026-06-19 (p4-media-scripting: `MediaScripting` none/initial-only/enabled, desktop default `enabled` — Lumen ships QuickJS, matches Edge) | **#35** |
