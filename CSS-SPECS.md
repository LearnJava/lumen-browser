...
| `overflow-anchor` | 🟡 | CSS Scroll Anchoring 1 §propdef-overflow-anchor: `auto \| none` parsed + computed-value round-trip (BUG-524 срез 1); no effect — no anchor-node-selection/suppression-heuristic/scroll-offset-adjustment algorithm exists in layout yet |
