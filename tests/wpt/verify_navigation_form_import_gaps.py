...
which bug each finding became:
    ...
    nav-pagehide-unload      the navigation happens and `pagehide` fires (with
                             ...
                             and `visibilitychange` never do    <- BUG-834
