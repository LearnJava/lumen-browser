...
**Порядок для P1:** U-0 ✅ → U-1 этап 1 ✅ → U-3 (TAB-серия) ✅ (TAB-1..7 готовы; TAB-7 `--ipc` 2026-06-18) → **U-2 (шрифты)** → U-4 (WASM, ранее у P2). U-1 этап 2 (пайплайн вне UI) — после разблокировки QuickJS `!Send`.
