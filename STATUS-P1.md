In progress: lumen-a11y-full stage 2 (8G, [P1+P3])  branch: p1-a11y-full-stage2
Next step: implement accname §4 algorithm + text alternative computation for form controls + title fallback chain
