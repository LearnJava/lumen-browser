...
**Порядок для P1:** U-0 ✅ → U-1 этап 1 ✅ → U-3 (TAB-серия) ✅ → U-2 этап 1 (GSUB/GPOS шейпинг) ✅ → U-2 этап 2 (CFF-контуры) ✅ → U-4 (WASM MVP + graceful stubs) ✅ 2026-06-18 → **далее: U-4 опции (SIMD/live-память/WebGPU backend) или унаследованные от P2 задачи**. U-1 этап 2 (пайплайн вне UI) — после разблокировки QuickJS `!Send`.
