...
Queue (Wave 3+):
Table layout algorithm                        box_tree.rs    ~3h  depends on P4 table CSS (done)
display: list-item marker box                 box_tree.rs    ~1h
Shadow DOM cascade + composed tree                           ~3h
Forms: ValidityState + validation pseudo                     ~2h

Recent: forms-layout 2026-05-21, css-nesting 2026-05-21, aspect-ratio 2026-05-21, flex-order 2026-05-21, css-units 2026-05-21, logical-properties 2026-05-21, quirks-table-cell-width 2026-05-21
