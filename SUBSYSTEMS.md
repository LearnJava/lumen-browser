...
| lumen-chrome | 🟡 build.rs parse-gate + id/action codegen + runtime host + hit-test/hover/dispatch, behind `LUMEN_CSS_CHROME=1` | [subsystems/chrome.md](subsystems/chrome.md) |
