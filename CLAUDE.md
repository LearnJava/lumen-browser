...
- **Всего тестов в workspace:** 672 (на момент последнего обновления).
...
```
*            css-font-stretch       — font-stretch (CSS Fonts L4 §2.5): десятые доли процента (u16), 9 keyword-ов с дробными semi-condensed=87.5% / semi-expanded=112.5%, численные % клампятся в [50%, 200%], inherited; bonus: добавил font_variant в text_rendering_eq (пропущенный инвариант от предыдущей задачи); 7 новых тестов
