...
- 84 unit + 12 snapshot-integration = 96 тестов.
...
- **Всего тестов в workspace:** 380 (на момент последнего обновления).
