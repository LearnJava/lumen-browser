...
- **Every test and measurement runs with the ad-block off** (user, 2026-09-23) — it is off by default; any harness that launches `lumen` sets `LUMEN_NO_ADBLOCK=1` as a guard against a profile where it was switched on ([`docs/automation.md`](docs/automation.md) §Env toggles).
