...
tiny-skia) + `driver/tests/snapshot_cpu.rs` compares 21 geometry pages against
...
covers FillRect/FillRoundedRect/DrawBorder/DrawOutline plus linear+radial gradients (incl.
repeating; page `39-gradients`). Coverage of text/image pages grows as `cpu_raster` gains those primitives.
