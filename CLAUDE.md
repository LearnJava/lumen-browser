...
| `docs/roadmap-trees.md` | **How to use the interactive roadmap trees** (`docs/roadmap-*.html` — generated and gitignored, run `python scripts/gen_roadmap.py` to get them): open in a browser, filters/search, and where their data comes from (`ROADMAP.md`, auto-pulling bug status from `BUGS.md`). |
