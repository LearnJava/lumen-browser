In progress: —
Next step: graphic-tests-migration (8A.6) — Rust-тесты со structural-ассертами + PNG-эталоны  crates/driver/tests/
