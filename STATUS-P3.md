...
**Текущее состояние (2026-05-30):** каркас есть (50 HTML, 50 PNG в `graphic_tests/snapshots/`, 50 Rust-тестов `crates/driver/tests/test_00..49.rs`), все зелёные. **Подзадачи (а), (б)-каркас, (б-2), (б-3 градиенты), (б-4 SVG-пути) ЗАВЕРШЕНЫ.** Дальнейшее расширение пиксельных эталонов — только по мере роста примитивов в `cpu_raster` (текст, картинки, conic).
