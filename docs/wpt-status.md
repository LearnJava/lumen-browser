...
| `generic-sensor` | 🚫 | ✅ |  | [BUG-393](../bugs/BUG-393-FIXED.md), [BUG-394](../bugs/BUG-394-OPEN.md) | Вендорена целиком 2026-07-28 (коммит `35be3b44`, `tests/wpt/generic-sensor/`, 11 файлов: `META.yml`, `WEB_FEATURES.yml`, 3 тестовых файла верхнего уровня, 3 общих `.js`-хелпера для всего семейства… [Подробности](wpt-vendor-notes/generic-sensor.md). |
