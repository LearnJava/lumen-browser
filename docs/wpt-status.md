...
| `fetch` | ⬜ | ✅ |  | [BUG-369](../bugs/BUG-369-FIXED.md), [BUG-370](../bugs/BUG-370-OPEN.md) | Вендорена целиком 2026-07-28 (коммит `35be3b44`, `tests/wpt/fetch/`, 985 файлов: `META.yml`/`README.md`, 23 подкатегории (`api/` — крупнейшая, далее `metadata/`, `fetch-later/`, `h1-parsing/`,… [Подробности](wpt-vendor-notes/fetch.md). |
