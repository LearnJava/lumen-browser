...
### TEST-3: срез 32 (2026-09-08) — `web-animations`, найден приём для «плавающих» подтестов
...
[BUG-1039](../../bugs/BUG-1039-OPEN.md).
...
подряд ×2 после исправления порядка — 0 регрессий. Baseline 237 → 238.
...
BUG-1039, ожидаемо). Категорий по-прежнему 238 (мерж не добавил новых).
