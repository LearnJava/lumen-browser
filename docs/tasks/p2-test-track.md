...
закоммичен — [BUG-1006](../../bugs/BUG-1006-OPEN.md), инфраструктурный блокер («нет
...
для этого среза + `websockets` не даёт вердикта на `--check`, [BUG-1006](../../bugs/BUG-1006-OPEN.md)).
...
Два оставшихся кандидата попали в [BUG-1006](../../bugs/BUG-1006-OPEN.md) — категория
...
[BUG-1006](../../bugs/BUG-1006-OPEN.md); baseline не записан, откатывать нечего).
