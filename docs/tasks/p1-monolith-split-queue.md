...
### Группа SH — `crates/shell/src/main.rs` (17 638 строк после SH-2)
...
| SH-6 | `impl Lumen` (15323) … до `winit_modifiers_state` (22797) | ~7 470 | САМЫЙ РИСКОВАННЫЙ. Только после SH-2…SH-5. Резать на подбатчи по методам: навигация/вкладки/команды IPC/session restore → каталог `src/lumen/` c `mod.rs`; `main.rs` должен стать bootstrap'ом ≤300 строк |
