...
2. **Панельный список риска-5 был неточным в обе стороны** — см. исправленную таблицу паритета выше:
   ...
   числился движковым, но не мигрирован ([BUG-403](../../bugs/BUG-403-OPEN.md)).
...
4. Побочно найдены 2 живых бага флипа CC-14, не пойманных чек-листом паритета: [BUG-403](../../bugs/BUG-403-OPEN.md)
...
|---|---|---|
| CC-15-1 | XS | Не удаление — закрыть [BUG-403](../../bugs/BUG-403-OPEN.md) (привязать `#profileMenu` к `ChromeModel` или явно вывести `profile_menu.rs` из скоупа удаления). Блокирует CC-15-3 |
