...
Сделано также: **4.1 ✅** — BT-1 распространён на все 7 крейтов (§4.1, merge 2026-07-12), 22 интеграционных бинаря → 7.
...
2. **4.2 фич-диета wgpu** (`default-features = false, features = ["dx12", "wgsl"]`) — сначала решить вопрос Vulkan-fallback; мерить S3.
