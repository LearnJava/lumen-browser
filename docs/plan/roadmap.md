> **Справочник.** Исходный roadmap проекта. Текущие задачи и статус сессий — в `STATUS-P1/P2/P3/P4/P5.md`. Этот файл читать только для исторического контекста спринтов.
