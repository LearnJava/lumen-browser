...
| **JS engine** (`v8` v150.1.0 — **дефолт с cutover S12, ADR-018, 2026-07-14, единственный shell-достижимый движок с S12b-F1, 2026-08-04**; `rquickjs` v0.11 — ещё зависимость `lumen-js`, но без shell-фичи, сносится срезами S12b-F2..F4) | Исполнение JavaScript | `JsRuntime` | V8 — 15 лет, миллиарды долларов, сотни инженеров. QuickJS был движком Phase 0–2; S0 go/no-go PASS 2026-07-13, cutover S12 2026-07-14. Новый код — только против V8-пути или движко-независимого шима (`WEB_API_SHIM`). |
