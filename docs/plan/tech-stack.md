...
| **JS engine** (`v8` v150.1.0 — **дефолт с cutover S12, ADR-018, 2026-07-14**; `rquickjs` v0.11 — только rollback-путь `--features quickjs`, сносится срезами S12b) | Исполнение JavaScript | `JsRuntime` | V8 — 15 лет, миллиарды долларов, сотни инженеров. QuickJS был движком Phase 0–2; S0 go/no-go PASS 2026-07-13, cutover S12 2026-07-14. Новый код — только против V8-пути или движко-независимого шима (`WEB_API_SHIM`). |
