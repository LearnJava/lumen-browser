...
досчитывают свои наборы. Третий прогон в тот же день, после закрытия BUG-774
(P1): **25/54 harness OK, 1237/1277 сабтестов** — harness-число не сдвинулось,
потому что оба файла `StorageEvent` и раньше доходили до конца, просто с
