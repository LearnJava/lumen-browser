...
* Интерактивность упирается в [BUG-926](../../bugs/BUG-926-FIXED.md) (нулевая ширина
  `<button>`) и [BUG-1044](../../bugs/BUG-1044-FIXED.md) (MCP-клик попадает в родителя).
...
* Кнопка недостижима кликом: `btn.getBoundingClientRect()` → `w=0`
  ...
  ([BUG-1044](../../bugs/BUG-1044-FIXED.md)) — `target=app/DIV`, а не кнопка.
...
[BUG-1044](../../bugs/BUG-1044-FIXED.md) на этом стенде больше не наблюдается —
...
[BUG-1044](../../bugs/BUG-1044-FIXED.md), которому здесь больше нечем
воспроизвестись.
